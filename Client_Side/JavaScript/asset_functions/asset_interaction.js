...
let bigData;
let increment;
function updateAsset(vin, make, model, colour, reg, v5cID,cert,ship, el)
{
	/*
	...
	*/
    ...
    bigData = [{'value':vin,'field':'VIN', 'title': 'VIN','v5cID':v5cID},{'value':make,'field':'make', 'title': 'Make','v5cID':v5cID},{'value':model,'field':'model', 'title': 'Model','v5cID':v5cID},{'value':colour,'field':'colour', 'title': 'Colour','v5cID':v5cID},{'value':reg,'field':'reg', 'title': 'Ownership Date','v5cID':v5cID},{'value':cert,'field':'certificate', 'title': 'Vehicle Custom Certificate','v5cID':v5cID},{'value':ship,'field':'shipment', 'title': 'Shipment Company','v5cID':v5cID}];
    increment=0;
